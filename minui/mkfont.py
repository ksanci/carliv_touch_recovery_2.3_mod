...
if (len(sys.argv) > 1):
	...
	print u"enter font name"
	fontname_en = 'fonts/' + raw_input() + '.ttf'

font_en = ImageFont.truetype(fontname_en , fontsize_en)
